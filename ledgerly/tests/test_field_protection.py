...
from ledgerly.core.field_protection import _find_blocking_configs, block_if_referenced
...
class TestBlockIfReferenced(unittest.TestCase):
    ...
    def test_allows_delete_when_no_blocking_configs(self):
        with patch(
            "ledgerly.core.field_protection._find_blocking_configs", return_value=[]
        ):
    ...
    def test_throws_when_blocking_configs_exist(self):
        with patch(
            "ledgerly.core.field_protection._find_blocking_configs",
...
class TestFindBlockingConfigsDB(unittest.TestCase):
    ...
    def test_returns_empty_for_unknown_field_on_existing_doctype(self):
        # "User" is always present but has no Ledgerly tracking.
