...
class LedgerConfig(Document):
    ...
    def _validate_dimensions(self):
        ...
        max_dims = frappe.local.conf.get("custom_ledger_max_dimensions", DEFAULT_MAX_DIMENSIONS)
...
_CLIENT_SCRIPT_PREFIX = "Custom Ledger - "
...
def _build_client_script(source_doctype: str) -> str:
    ...
    deduplication guard (frm._custom_ledger_viewed) prevents duplicate API
    ...
    method = json.dumps(
        "custom_ledger.custom_ledger.api.source_doctype_buttons.get_ledger_views_for_record"
    )
