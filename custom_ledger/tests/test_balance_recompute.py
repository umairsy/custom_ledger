...
from custom_ledger.core.balance_recompute import (
...
class TestRecomputeOnLoadFastExits(unittest.TestCase):
    ...
    def test_skips_when_engine_flag_set(self):
        """No DB call should happen when custom_ledger_engine_writing is True."""
        ...
        try:
            ...
            frappe.flags.pop("custom_ledger_engine_writing", None)
